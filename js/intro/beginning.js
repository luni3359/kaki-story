function gameNewStart() {
    ...
    results in complete blankness. Starting to panic a little, you try to at the very least remember your name.`);

    // askWord works for asking a word!
    // the button says OK by default if you don't specify a word
    askWord('<b>What is your name?</b>', whatIsYourName);
}
...
function whatIsYourName() {
    ...
    setOption('Male', function () {
        alert('wrong choice');
    });
    setOption('Female', function () {
        alert('NICE BRA');
    });
}
